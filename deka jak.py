#WRITTEN BY TOUFIK VAYA
#FOLLOW MY GITHUB : https://facebook.com/CT.Toufik
#----------import----------#
...
def m1(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            sys.stdout.write('\r\r [RUNNING] %s|TOUFIK:%s '%(loop,len(oks)));sys.stdout.flush()
